...
echo.
xcopy clientscripts ..\..\raw\clientscripts /SY
echo.
xcopy xcommon_rtx.csv ..\..\zone_source /SY
echo.
...
cd ..\..\bin
linker_pc.exe -language english -compress -cleanup xcommon_rtx
...
echo.
echo ----------------- Copy fastfiles ----------------------
MOVE ..\..\zone\english\xcommon_rtx.ff
copy xcommon_rtx.ff "..\..\zone\Common\xcommon_rtx.ff"
