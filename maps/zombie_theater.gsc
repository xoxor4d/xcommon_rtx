...
main()
{
	...
	level thread spawn_rtx_markers();
	init_zombie_theater();
...
spawn_rtx_markers()
{
	precachemodel("mm_zm_theater01");
	precachemodel("mm_zm_theater02");
	precachemodel("mm_zm_theater03");
	precachemodel("mm_zm_theater04");
	precachemodel("mm_zm_theater05");
	precachemodel("mm_zm_theater06");
	precachemodel("mm_zm_theater07");
	precachemodel("mm_zm_theater08");
	precachemodel("mm_zm_theater09");
	precachemodel("mm_zm_theater10");
	precachemodel("mm_zm_theater11");
	precachemodel("mm_zm_theater12");
	...
	marker = spawn("script_model", (1412, 	 -626, 	 388));		marker setmodel("mm_zm_theater03");
	marker = spawn("script_model", (1580,	  452,	 217));		marker setmodel("mm_zm_theater04");
	marker = spawn("script_model", (1346,	 1385,	 132));		marker setmodel("mm_zm_theater05");
	marker = spawn("script_model", ( -15,	 1542,	 224));		marker setmodel("mm_zm_theater06");
	marker = spawn("script_model", ( -16,	  451,	 353));		marker setmodel("mm_zm_theater07");
	marker = spawn("script_model", ( -964,	 -676,	 192));		marker setmodel("mm_zm_theater08");
	marker = spawn("script_model", (-1523,	  892,	 259));		marker setmodel("mm_zm_theater09");
	marker = spawn("script_model", (-1410,	 -210,	 340));		marker setmodel("mm_zm_theater10");
	marker = spawn("script_model", ( 1323,	 2472,	-274));		marker setmodel("mm_zm_theater11");
	marker = spawn("script_model", ( 1866,	-2337,	 220));		marker setmodel("mm_zm_theater12");
	...
	{
		players[i] iprintln("SPAWN MAP MARKERS");
	} */
}
